package packagefifteen.userdefinedobjects.comparableandcomparator;
...
public class ListDemo {
	...
	public static void main(String[] args) {
		...
		// Adding User Defined objects into ArrayList
				...
				Person pe1 = new Person("Abhijit", "Mumbai");
				personList.add(pe1);

				pe1 = new Person("Milind", "Pune");
				personList.add(pe1);

				pe1 = new Person("Saurav", "Bangalore");
				personList.add(pe1);

				pe1 = new Person("Madhur", "Delhi");
				personList.add(pe1);
